...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Immerss Tracking Visit",
  "categories": ["SALES"],
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
  ...
  "description": "Insert immerss tracking visit code",
  "containerContexts": [
    "WEB"
  ]
}
...
const successHandler = function() {
  log('ImmerssTrackingVisit: Success loaded.');
  data.gtmOnSuccess();
};

const failureHandler = function() {
  log('ImmerssTrackingVisit: Loaded with failure!');
  data.gtmOnFailure();
};

const url = 'https://portal.immerss.live/vece/affiliate/v1/tracking/' + encodeUriComponent(data.appId) + '/visit.js';
log('ImmerssTrackingVisit:buildedUrl', url);
injectScript(url, successHandler, failureHandler, url);
...
Created on 28.06.2022, 15:26:36
